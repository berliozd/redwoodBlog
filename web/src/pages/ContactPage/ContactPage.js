...
import {FieldError, Form, FormError, Label, Submit, TextAreaField, TextField, useMutation} from '@redwoodjs/web'
  ...
  return (
    <BlogLayout>
      <Form onSubmit={onSubmit} validation={{mode: 'onblur'}} formMethods={formMethods} error={error}>
        ...
        <Label name="message" errorClassName="error">Your message</Label>
